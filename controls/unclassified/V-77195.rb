...
\"Options:\".  It is recommended the file be in a read-only network location."
  describe "Check Ensure Exploit Protection system-level mitigation to validate DEP is set to ON  by running Get-ProcessMitigation -System in PowerShell Command" do
